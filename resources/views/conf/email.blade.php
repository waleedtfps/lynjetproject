    ...
    <body>
        <div class="content-wrap" style="display: block;Margin:0 auto;margin:0 auto;background-color: #001f3f;width:600px;">
            ...
            <div class="text-div" style="margin: 50px auto;Margin:50px auto;">
                <h1>Hello <span style="color:#001f3f;text-transform: uppercase;Margin-left:10px;margin-left:10px;">{{$name}}</span></h1>
                <h3 style="margin: 30px auto;Margin:30px auto;">Hit verify to complete registration and get ready to get on-board with us</h3>
                
            </div>
            <a href="{{ URL::to('register/verify/' .$confirmation_code)}}" style="background-color: #001f3f;border:3px solid #001f3f;display: inline-block;padding: 10px 40px;box-shadow: 1px 3px 5px #001f3f;text-decoration: none;cursor: pointer;color: white;margin: 30px auto;Margin:30px auto;">VERIFY</a>
            </div>
