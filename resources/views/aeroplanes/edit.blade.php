...
<div class="col-sm-12 box fullheight">
    <!-- Nav tabs -->
     <form class="form-horizontal" role="form" action="{{URL::to('aeroplanes/update/'.$aeroplanes->id)}}"  enctype="multipart/form-data" method="POST">
                {!! csrf_field() !!}
    <div class="col-md-12">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        ...
                        <div class="form-group  col-md-6">
                            ...
                            <div class=" col-sm-7">
                                ...
                                <option @if($aeroplanes->id_company == $company->id) selected @endif value="{{$company->id}}">{{$company->company_name}}</option>
                                  @endforeach
                                </select>
                            </div>
                        </div>
